...
import com.example.lab2.Counter;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    Counter myCounterInterface;

    public RecyclerViewAdapter(ArrayList<Technology> technologies, Counter c) {
        super();
        this.technologies = technologies;
        this.myCounterInterface = c;
    }
...
counter++;
Toast.makeText(getActivity(), "Images loaded: "+String.valueOf(counter), Toast.LENGTH_SHORT).show();
 */
